 ...
 *
 * Signals modified version from http://www.kilometer0.com/blog/2010/03/27/swfaddress-as3signals-robotlegs-demo/
 */
/**
...
package com.asual
{
	 ...
	 * SWFAddress class. 
	 */
	public class SWFAddress implements ISWFAddress
	{
		 ...
		 */
		public  var _initSig:Signal = new Signal();
		/**
		 * Dispatched when any value change.
		 */
		public  var _change:Signal = new Signal();
		/**
		 * Dispatched when value was changed by Flash.
		 */
		public  var _internalChange:Signal = new Signal();
		/**
		 * Dispatched when value was changed by Browser.
		 */
		public  var _externalChange:Signal = new Signal();

		public function get init():Signal
		{
			return _initSig;
		}
		...
		public function get internalChange():Signal
		{
			return _internalChange;
		}

		public function get externalChange():Signal
		{
			return _externalChange;
		}
