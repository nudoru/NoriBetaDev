package com.nudoru.visual
{
	...
	public class SWFLoader extends MovieClip {
		...
		public function SWFLoader(n:String, t:Sprite, initObj:Object):void {
			...
			_ImgLoader.contentLoaderInfo.addEventListener(IOErrorEvent.IO_ERROR, onImageError, false, 0, true);
			_ImgLoader.contentLoaderInfo.addEventListener(ProgressEvent.PROGRESS, onImageProgress, false, 0, true);
			_ImgLoader.contentLoaderInfo.addEventListener(Event.COMPLETE, onImageComplete, false, 0, true);
