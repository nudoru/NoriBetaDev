package com.nudoru.utilities {
	...
	/**
	 * Timer object wrapper with a little more functionality
	 * 
	 * @author Matt Perkins
	 */
	public class TimeKeeper extends EventDispatcher {
		...
		public function start():void {
			_TheTimer.stop();
			_TheTimer.reset();
			_TheTimer.addEventListener(TimerEvent.TIMER_COMPLETE, onTimerExpire, false, 0, true);
			_TheTimer.addEventListener(TimerEvent.TIMER, onTimer, false, 0, true);
			_TheTimer.start();
